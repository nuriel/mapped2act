...
class ActsControllerTest < ActionController::TestCase
  ...
  test "should create act" do
    assert_difference('Act.count') do
      post :create, act: { description: @act.description, name: @act.name, presentation: @act.presentation, url: @act.url }
    end
  ...
  test "should update act" do
    put :update, id: @act, act: { description: @act.description, name: @act.name, presentation: @act.presentation, url: @act.url }
    assert_redirected_to act_path(assigns(:act))
  end
